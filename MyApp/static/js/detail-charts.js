...
function monthlyVC() {
    ...
    var option = {
        ...
        series: [{
            ...
            data: recently_months_comments_amount,
        },
        ],
        color:['#8ECF67','#1E91CF'],
    };
...
function areaVisits() {
	var cityMap = {
		...
		function showMap(lv,name) {
            $("#map").html("");
            var map = echarts.init(document.getElementById('visits_china_map'), 'shine');
            window.onresize = map.resize;
            if (lv == 1) {
                $.get('static/china.json', function (json) {
                ...
                var py = provinceMap[name];
                if (typeof py != "undefined") {
                    $.get('static/province/' + py + '.json', function (json) {
